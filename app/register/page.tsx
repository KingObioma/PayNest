        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Join PayNest and start paying bills easily
            </p>
          </div>
          ...
          <Card className="p-6">
            ...
            <div className="bg-primary-50 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 rounded-lg p-4 mb-6">
              <p className="text-sm text-primary-700 dark:text-primary-300 text-center">
                This is a demo. Click &quot;Demo Register&quot; to access the dashboard.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 mt-0.5 rounded border-gray-300 text-primary focus:ring-primary" />
            ...
            <Button
              ...
              isLoading={isLoading}
            >
              Demo Register (Skip to Dashboard)
            </Button>
